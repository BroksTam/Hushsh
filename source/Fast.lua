...
{
{text = '⦗ حظر ⦘ : '..BanGroupz, data =user..'/statusban/'..useri},{text = '⦗ كتم ⦘ : '..SilentGroupz, data =user..'/statusktm/'..useri},
},
{
...
MsgText = 'بعدك جديد ع سالفه تفاعل لو شوضعك؟'
elseif tonumber(Message) < 200 then 
MsgText = 'شد الهمه حبيبي'
elseif tonumber(Message) < 400 then 
MsgText = 'شد حيلك بلتفاعل حبيبي'
elseif tonumber(Message) < 700 then 
MsgText = 'ماكو احسن منك بلتفاعل'
elseif tonumber(Message) < 1200 then 
MsgText = 'عفيه حبي هيج اريدك نار'
elseif tonumber(Message) < 2000 then 
MsgText = 'شده بعد حبيبي وراك تمويل'
elseif tonumber(Message) < 3500 then 
MsgText = 'عاشت ايدك ع هلتفاعل'
elseif tonumber(Message) < 4000 then 
MsgText = 'استمر يابطل '
elseif tonumber(Message) < 4500 then 
MsgText = 'عمي عاشو ع هل تفاعل'
elseif tonumber(Message) < 5500 then 
MsgText = 'عمي انته مخرب الوضع بتفاعلك'
elseif tonumber(Message) < 7000 then 
MsgText = 'احلا تفاعل شفته بحياتي'
elseif tonumber(Message) < 9500 then 
MsgText = 'تفاعل حقيقي ابوسك'
elseif tonumber(Message) < 59698717221 then 
MsgText = 'ماكو منك بلتفاعل حبحب' 
end 
return MsgText 
end
...
{
{text = '⦗ تغير معلومات كروب ⦘ : '..info, data = UserId.. '/info'}, 
},
{
...
{
{text = '⦗ اضافه بوتات ⦘  : '..other, data = UserId.. '/other'}, 
},
{
...
if text == '⦗ المجموعات ⦘' or text == 'الكروبات البوت' or text == 'لينك الكروبات' then
if not msg.Asasy then 
...
local G = "↯︙هاذه هي قائمه روابط الكروبات في البوت  \n"
local list = Redis:smembers(Fast..'ChekBotAdd')  
for k,v in pairs(list) do  
...
local list = Redis:smembers(Fast.."ChekBotAdd")
send(Sudo_Id,0,"*↯︙ تم اضافه البوت في كروب جديد ولكن لم يتم تفعيله ولا تم رفعه مشرف *\n↯︙  عدد المجموعات *"..#list.."* مجموعه","md",true)
end
...
_key = {
{{text="⦗ اضغط هنا الانهاء الاضافه ⦘",callback_data="EndAddarray"..senderr}},
}
...
inlin = {
{{text = '⦗ اضغط هنا الالغاء ⦘',callback_data=senderr..'/cancelrdd'}},
}
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/IoutB ", 'md', true)
end
...
{
{text = '⦗  اضغط هنا الارسال سؤال  ⦘', url = 't.me/'..UserBot..'?start=7azer'..msg_chat_id..'from_id'..msg.sender_id.user_id}, 
},
}
}
...
send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"↯︙ تم تفعيل امر ردي").Lock,"md",true)  
end
...
send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"↯︙ تم تعطيل امر ردي ").Lock,"md",true)  
end
--
...
send(msg_chat_id,msg_id,"↯︙ الان ارسل محتوي الزر \n↯︙ارسل نص او ميديا او رابط فقط حيث يظهر عند ضغط العضو عليه","md",true)  
return false  
end
...
return send(msg_chat_id,msg_id,"↯︙ اذا تستخدم الميديا ف كله ميديا واذا نص لازم كله نص ! ","md")  
end
Redis:set(Fast.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id, "set_inline")
...
{
{text = '⦗  تنزيل كل رتب  ⦘ ', data =senderr..'/statusmem/'..UserId_Info.id},
},
{
{text = '⦗ اخفاء  ⦘ ', data ='/delAmr1'}
}
...
{
{text = '⦗ تنزيل جميع الرتب ⦘', data =senderr..'/statusmem/'..rep_idd},
},
{
{text = '⦗ اخفاء ⦘', data ='/delAmr1'}
}
...
{{text="⦗ الغاء ⦘",data="/HideGroupVip:"..senderr}},
{{text='- 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.',url='t.me/ioutb'}},
}
}
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
...
{
{text = '⦗  تغير معلومات كروب  ⦘ : '..info, data =senderr..  '/info'}, 
},
{
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(2100004938) then
local txx = "\n"
...
data = {
{
{text = '⦗ اضغط هنا الارسال همسه ⦘', url = 't.me/'..UserBot..'?start=hms'..testhms..'from_id'..msg.sender_id.user_id}, 
},
}
}
