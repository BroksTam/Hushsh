...
data = {
{
{text = '⦗ تغير معلومات كروب ⦘ : '..(t1 or change_info), data = UserId..'/groupNum1//'..user2}, 
},
{
...
{
{text = '⦗ دعوه المستخدمين ⦘ : '..(t4 or invite_users), data = UserId..'/groupNum4//'..user2}, 
},
{
{text = '⦗ مسح الرسائل ⦘ : '..(t5 or delete_messages), data = UserId..'/groupNum5//'..user2}, 
},
{
{text = '⦗ اضافه مشرفين ⦘ : '..(t6 or promote), data = UserId..'/groupNum6//'..user2}, 
},
{
...
{
{text = '⦗ تنزيل جميع رتب لعضو ⦘  ', data =user..'/statusmem/'..useri},
},
{
...
MsgText = '⦗ خابص الدنيا لاعقل ولاتفاعل ⦘' 
elseif tonumber(Message) < 200 then 
MsgText = '⦗ شد تفاعلك شويه حبيبي ⦘' 
elseif tonumber(Message) < 400 then 
MsgText = '⦗ انته شوكت ناوي تشد تفاعل ⦘'
elseif tonumber(Message) < 700 then 
MsgText = '⦗ مبين بديت تعقل وتتفاعل حبيتك⦘'
elseif tonumber(Message) < 1200 then 
MsgText = '⦗ هيج عاجبني تفاعلك لتتراجع⦘'
elseif tonumber(Message) < 2000 then 
MsgText = '⦗ لوهيج التفاعل لو مينراد ⦘'
elseif tonumber(Message) < 3500 then 
MsgText = '⦗ تفاعل بعد ونزوجك ومهرك ع المالك ⦘'
elseif tonumber(Message) < 4000 then 
MsgText = '⦗ استمر بهل تفاعل حبيتك ⦘'
elseif tonumber(Message) < 4500 then 
MsgText = '⦗ عمي مو تفاعل ضيم استمر لتوكف ⦘'
elseif tonumber(Message) < 5500 then 
MsgText = '⦗ انت مولعها هنا وخارب الوضع بتفاعلك ⦘'
elseif tonumber(Message) < 7000 then 
MsgText = '⦗ تفاعلك يشك استمر ولتهتم ⦘'
elseif tonumber(Message) < 9500 then 
MsgText = '⦗ عمي مخرب الجو والاجواء بتفاعلك ⦘'
...
data = {
{
{text = '⦗ ارسال ويب ⦘ : '..web, data = UserId..'/web'}, 
},
{
...
return send(msg_chat_id,msg_id, '↯︙ تم تغيير صوره‏‏ آلترحيب للبوت\n✓')
end
...
'\n↯︙ آختصـآصـي حمايه‌‏ آلمـجمـوعآت'..
'\n↯︙ مـن آلسـبآم والتوجيه‌‏ وآلتگرآر وآلخ...'..
...
if text == 'الكروبات البوت' or text == 'الكروبات البوت' or text == '⦗ المجموعات ⦘' then
if not msg.Asasy then 
...
local G = "↯ ︙هاذه هي قائمه كروبات البوت عزيزي \n"
local list = Redis:smembers(Fast..'ChekBotAdd')  
for k,v in pairs(list) do  
...
if text == 'تحديث السورس' or text == '⦗تغيير المطور الاساسي⦘ then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id,'\n\n↯︙الكود صالح فقط لمبرمج السورس !',"md",true)  
end
...
{{text="وضع بوتي",data="/ChangeBotVip:"..senderr}},{{text="وضع الكروبي",data="/ChangeGroupVip:"..senderr}},
{{text="اخفاء",data="/HideChanneVip:"..senderr}},
{{text='- 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.',url='t.me/ioutb'}},
}
}
...
type = 'inline',
data = {
{{text="تغيير الكروبي",data="/ChangeGroupVip:"..senderr},{text="حذف الكروبي",callback_data="/DelGroupVip:"..senderr}},
...
type = 'inline',
data = {
{{text="تغيير عمري",data="/ChangeSunniVip:"..senderr},{text="حذف عمري",callback_data="/deleteSunni:"..senderr}},
...
{{text="وضع الكروبي",data="/ChangeGroupVip:"..senderr}},{{text="وضع قناتي",data="/ChangeChanneVip:"..senderr}},
