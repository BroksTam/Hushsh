...
if text == "حذف قسم" then
  ...
  if ChannelJoin(msg) == false then
  local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Ioutb'}, },}}
  return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
  end
...
return send(msg_chat_id,msg_id," ","md")  
end
Redis:set(Fast.."Set:Sections:inline"..msg.sender_id.user_id..":"..msg_chat_id, "set_inline")
...
{{text="⦗ وضع قناتي ⦘",data="/ChangeBotVip:"..senderr}},{{text="⦗ وضع كروبي ⦘",data="/ChangeGroupVip:"..senderr}},
{{text="⦗ اخفاء ⦘",data="/HideChanneVip:"..senderr}},
{{text='- 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.',url='t.me/ioutb'}},
}
}
...
return send(msg_chat_id,msg_id,"⦗ اضغط بلاسفل لارسال همسه ⦘ الى"..first_name.." ","html",true,false,false,false,reply_markup) 
end
end
end
