...
{
{text = '◜  تواصل المطور◞.', url = "https://t.me/Q_Qebot"}
},
{
...
local Mostafa = {
'↯︙ ها يمعود شتريد ؟',
'↯︙ احجي فضني ترا مشغول موفارغلك اني ؟',
'↯︙ ها حبيبي تفضل ؟',
'↯︙ داسبح حبي خلكمل',
'↯︙ نجب واكلخرا لدوخني منزعج ترا !',
'↯︙ ها يبن جلب احجي ؟',
'نعم يا قلب '..NamesBot..' ؟',
}
...
if Redis:get(Fast.."name bot type : ") == "photo" then
    ...
    if photo.total_count > 0 then
      ...
      "شلون وتالي وياك انت بس كلي ؟",
      "اسمي "..NamesBot.." وحك جلاب الحمزه",
      "تفضل واختصر ترا مشغول ؟"
      }
    ...
    return bot.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md") 
      ...
      "اسمي "..NamesBot.." يبن الجلب",
      "يارب يكون موضوع مهم بس",
      "ماعدي غيرك اليوم بس اكلك تفضل وشتريد ؟",
      "اسمي "..NamesBot.."يمعود لاتجفرنه ",
      "اعمل حالك ميت  ؟"
      }
    return bot.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md") 
