...
if Redis:get(Fast.."Faste:Welcome:Group" .. msg_chat_id .. "" .. msg.sender_id.user_id) then 
if text == "الغاء" then 
Redis:del(Fast.."Faste:Welcome:Group" .. msg_chat_id .. "" .. msg.sender_id.user_id)  
...
if text == 'رفع نسخه بروكس' and msg.reply_to_message_id ~= 0 then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return send(msg_chat_id,msg_id,'↯︙ تم استرجاع المجموعات من نسخه بروكس')
else
...
if i <= Count then  Text = Text..i.."ـ ["..(GetAllNames[v[2]] or "خطأ بالأسـم").."](tg://user?id="..v[2]..") - {*"..v[1].."*}  \n" end ; i=i+1
end
...
_key = {
{{text="⦗ انهاء ⦘",callback_data="EndAddarray"..senderr}},
}
...
inlin = {
{{text = '⦗ الغاء ⦘',callback_data=senderr..'/cancelrdd'}},
}
...
data = {
{
{text = '⦗ مسح اللعبه الحاليه ⦘', data = Userid..'/del7azer'}, 
},
}
}
...
data = {
{
{text = '⦗ انضمام ⦘', data = msg.sender_id.user_id..'/add7azer'}, 
},
{
...
if text == "حذف قسم" then
  ...
  data = {
   {
   {text = '⦗ الغاء ⦘', data = msg.sender_id.user_id..'/cancelrdd'},
  },
   }
  }
...
if text == "امثله" or text == "مثال" then
JABWA = math.random(3,30); 
local Text ='*- جاهز للعب ياصديقي؟ *'
local keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '- بدء اللعب', callback_data=senderr..'/amthla'},
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/amthla/2/'..JABWA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboardd)) 
end
if text =='رقمي' then
local UserInfo = bot.getUser(senderr)
...
{
{text = '⦗ حظر ⦘ : '..BanGroupz, data =senderr..'/statusban/'..UserId_Info.id},{text = '⦗ كتم ⦘ : '..SilentGroupz, data =senderr..'/statusktm/'..UserId_Info.id},
},
{
{text = '⦗ اخلاء اي رتبه من العضو ⦘', data =senderr..'/statusmem/'..UserId_Info.id},
},
{
...
{
{text = '⦗ حظر ⦘ : '..BanGroupz, data =senderr..'/statusban/'..rep_idd},{text = '⦗ كتم ⦘ : '..SilentGroupz, data =senderr..'/statusktm/'..rep_idd},
},
{
{text = '⦗ اخلاء اي رتبه من العضو ⦘', data =senderr..'/statusmem/'..rep_idd},
},
{
{text = '⦗ اخفاء ⦘', data ='/delAmr1'}
}
...
local Info_Members = bot.searchChatMembers(msg_chat_id, "*", 250)
local List_Members = Info_Members.members
listall = '\n*↯︙ قائمه الاعضاء \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(List_Members) do
local UserInfo = bot.getUser(v.member_id.user_id)
...
{
{text = '⦗ صورتي الثانيه ⦘', callback_data=senderr.."/sorty2"},
},
}
...
{{text='- 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.',url='t.me/ioutb'}}, 
}
}
...
type = 'inline',
data = {
{{text="⦗ تغير قناتي ⦘",data="/ChangeChanneVip:"..senderr},{text="⦗ حذف قناتي ⦘",callback_data="/DelChanneVip:"..senderr}},
{{text="⦗ وضع بوتي ⦘",data="/ChangeBotVip:"..senderr}},{{text="⦗ وضع كروبي ⦘",data="/ChangeGroupVip:"..senderr}},
{{text="⦗ اخفاء ⦘",data="/HideChanneVip:"..senderr}},
{{text='- 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.',url='t.me/ioutb'}},
}
}
...
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ↯︙ تم الغاء حفظ الكروبك *',"md",true)  
Redis:del(Fast..'SetGroupVip'..senderr)
return false  
end 
Redis:del(Fast..'SetGroupVip'..senderr)
Redis:set(Fast..'SOFI:Group:Vip'..senderr,text)
local text = "*↯︙ تم حفظ الكروبك بنجاح *"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text="⦗ تغير كروبي ⦘",data="/ChangeGroupVip:"..senderr},{text="⦗ حذف كروبي ⦘",callback_data="/DelGroupVip:"..senderr}},
...
if text and text:match("^ضع الكروبي$") or text and text:match("^وضع الكروبي$") then
if not msg.Admin then
return send(msg_chat_id,msg_id,'*\n ↯︙ عذرآ الامر يخص〘 '..Controller_Num(7)..' 〙*',"md",true)  
end
local text = "*↯︙ حسنا ارسل لي الكروبك الان*"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
type = 'inline',
data = {
{{text="⦗ تغير اسمي ⦘",data="/ChangenameVip:"..senderr},{text="⦗ حذف اسمي ⦘",callback_data="/DelnameVip:"..senderr}},
{{text="⦗ وضع عمري ⦘",data="/ChangeSunniVip:"..senderr}},
...
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ↯︙ تم الغاء حفظ عمرك  *',"md",true)  
Redis:del(Fast..'SetSunniVip'..senderr)
return false  
end 
Redis:del(Fast..'SetSunniVip'..senderr)
Redis:set(Fast..'Game:Sunni'..senderr,text)
local text = "*↯︙ تم حفظ اسمك عمرك *"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text="⦗ تغير عمري ⦘",data="/ChangeSunniVip:"..senderr},{text="⦗ حذف عمري ⦘",callback_data="/deleteSunni:"..senderr}},
...
if text and text:match("^ضع عمري$") or text and text:match("^وضع عمري$") then
if not msg.Admin then
return send(msg_chat_id,msg_id,'*\n ↯︙ عذرآ الامر يخص〘 '..Controller_Num(7)..' 〙*',"md",true)  
end
local text = "*↯︙ حسنا ارسل لي عمرك الان *"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
type = 'inline',
data = {
{{text="⦗ تغير بوتي ⦘",data="/ChangeBotVip:"..senderr},{text="⦗ حذف بوتي ⦘",callback_data="/DelBotVip:"..senderr}},
{{text="⦗ وضع كروبي ⦘",data="/ChangeGroupVip:"..senderr}},{{text="⦗ وضع قناتي ⦘",data="/ChangeChanneVip:"..senderr}},
...
if text == 'مسح عمري' or text == 'حذف عمري' then
Redis:del(Fast..'Game:Sunni'..senderr)
send(msg.chat_id,msg.id, "*↯︙ تم مسح عمرك بنجاح *","md",true)
end
...
if text and text:match("^مسح كل (.*)$") then
  ...
  if #owner_list == 0 then 
    ...
    Redis:srem(Fast.."Ownerss:Group"..msg_chat_id, v)
...
if text == ("الرتب المضافه") then
  ...
  if ChannelJoin(msg) == false then
  local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/iinzzz '}, },}}
  return send(msg.chat_id,msg.id,'*\n↯ ︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
  end
...
Redis:set(Fast.."del:rtba"..msg.sender_id.user_id..":"..msg_chat_id, true)
local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and Redis:get(Fast.."del:rtba"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
  ...
  Redis:del(Fast.."del:rtba"..msg.sender_id.user_id..":"..msg_chat_id)
...
if text == ("اضف رتبه") then
  ...
  Redis:set(Fast.."Set:rtba"..msg.sender_id.user_id..":"..msg_chat_id, true)
  local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and Redis:get(Fast.."Set:rtba"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
  Redis:srem(Fast.."rowtab:", text)
  Redis:del(Fast..text.."type:")
  Redis:del(Fast.."Set:rtba"..msg.sender_id.user_id..":"..msg_chat_id)
  local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
...
if rtba_type == "owner" then 
  ...
  if Redis:sismember(Fast.."rtba:"..rtba..":"..msg_chat_id, Message_Reply.sender_id.user_id) then 
    ...
    Redis:sadd(Fast.."Ownerss:Group"..msg_chat_id, Message_Reply.sender_id.user_id)
...
if rtba_type == "owner" then 
  ...
  if Redis:sismember(Fast.."rtba:"..rtba..":"..msg_chat_id, Message_Reply.sender_id.user_id) then 
    Redis:srem(Fast.."Ownerss:Group"..msg_chat_id, Message_Reply.sender_id.user_id)
...
Redis:setex(Fast.."Faste:Welcome:Group" .. msg_chat_id .. "" .. senderr, 120, true)  
local textett =[[
↯︙ ارسل لي الترحيب عام الان
↯︙ تستطيع اضافة مايلي !
يمكنك استخدام الدوال الاتيه 
...
return send(msg_chat_id,msg_id,"↯︙ لم يتم تعيين ترحيب للالكروب","md",true)   
end 
end
...
return send(msg_chat_id,msg_id,"↯︙ ارسل الصوره لوضعها للالكروب","md",true)    
end
...
data = {
{
{text = '⦗ الغاء ⦘', data =senderr..'/cancelamr'}
},
}
}
...
local list = Redis:smembers(Fast.."Fast:all:Sticker"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⇜ ابشر مسحت ( "..k.." ) من الملصقات"
bot.deleteMessages(msg.chat_id,{[1]= Message})
Redis:del(Fast.."Fast:all:Sticker"..msg.chat_id)
end
end
if #list == 0 then
...
data = {
{
{text = '⦗ اضغط هنا لارسال همسه ⦘', url = 't.me/'..UserBot..'?start=hms'..testhms..'from_id'..msg.sender_id.user_id}, 
},
}
}
return send(msg_chat_id,msg_id,"↯︙ اضغط لارسال همسه الى ~ "..first_name.." ","html",true,false,false,false,reply_markup) 
end
end
end
...
data = {
{
{text = '⦗ اضغط للانضمام للعبه ⦘', data = '/joinerolet'},
},
}
}
...
if text == "تفعيل نبذه" and ChCheck(msg) then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*✫︙هذا الامر يخص { "..Controller_Num(6).." }* ","md",true)  
end
LuaTele.sendText(msg_chat_id,msg_id,GetByName(msg).."*✫︙تم تفعيل نبذه*","md",true )
Redis:del(Fast.."Fast:biousers"..msg.chat_id) 
end
if text == "تعطيل نبذه" and ChCheck(msg) then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*✫︙هذا الامر يخص { "..Controller_Num(6).." }* ","md",true)  
end
LuaTele.sendText(msg_chat_id,msg_id,GetByName(msg).."*✫︙تم تعطيل نبذه*","md",true )
Redis:set(Fast.."Fast:biousers"..msg.chat_id,true)  
end
if text == 'نبذه' and not Redis:get(Fast.."Fast:biousers"..msg.chat_id) then
...
'  هل تعتقد أن حبيبتك / حبيبك يفكر بك الآن؟ أم هل تظن أنه منشغل بأمر آخر ؟',
'  عندك اسرار ومواضيع ودك تقفل عليها بصندوق وترميها في ابحر ؟',
'  ماعو اصعب شيء في الحياه؟ قال الاول : الحب من طرف واحد .قال الثاني : الفقر اصعب شيء . قال الثالث : ان تحزن ولايشعر بك احد . قال الرابع : انك تعيش في الدنيا وحيد . ماذا تقول انت ؟',
'  هل تؤمن بمقوله السهل ميصير صعب ؟',
'  فيك بشخصيتك ال عدم مشاركه ب اشيائك ؟',
'  كلمتك الشهيره عندما تريد اختصار موضوع ما ؟',
'  ماهو الهرمون المرتفع لديك حاليا ؟',
'  مهربك الوحيد عند انكسارك ؟',
'  هل تنازلت عن بعض احلامك وطموحاتك،حتى تعيش واقعك ؟',
'  عدد سكان الارض 8 مليار كم صديق لك منهم ؟',
'  ماهي الحياه المثاليه بالنسبه اليك ؟',
'  مشهور بعائلتك ولا من المنسيين ؟',
'  اكثر مكان تكتب وتفضفض فيه ؟',
'  اقدم شيء محتفظ فيه من صغرك ؟',
'  اسم ماتحبه ؟',
'  منشن شخص تحسه نعمه من الله ؟',
'  كلام ودك يوصل لشخصك المطلوب ؟',
'  منشن شخص تسولف معه وتنسى هموم الدنيا ؟',
'  هل برأيك أن عبارة "محد لأحد" صحيحه ام تعقتد عكس ذلك؟ ؟',
'  منشن شخص فاهمك ف كلشي ؟',
'  شي مستحيل ترفضه ؟',
'  كم عدد الي معطيهم بلوك ؟',
'  تتعايش مع شخص مختلف عنك فكرياً ؟',
'  هل يمكن للاسباب التافهه ان تدمر الاشياء العظيمه  ؟',
'  تصرف او طبع تحب ان يتركه شخص المقرب منك ؟',
'  هل روحك الجميله كسرت من قبل شخص لم تتوقعه ؟',
'  كلمه الاخر شخص طلع من حياتك ؟',
'  نوعيات ودك يتقرضون من سوشل ميديا ؟',
'  هل سبق وقلت ياليت كنت... ؟',
'  هل سبق وكتبت اغنيه لشخص ما ؟',
'  اكثر مقوله تحبها وتنطبق عليك ؟',
'  شيء المجتتمع فاهمه غلط ؟',
'  اكثر شخص قريب منك بالعائله ؟',
'  الاعتذار بالنسبه الك ينهي كل شيء ؟',
'  شي لو فقدته تصير نفسيه ؟',
'  حياتك عباره عن... ؟',
'  كلمه للشخص الفضولي ؟',
'  اسرع شي يرضيك اذا زعلت ؟',
'  اشخاص تحب سواليفهم ؟',
'  أحياناً دقائق من الاهتمام تنسي عاماً كاملاً من الألم. ! * هل تتفق ؟ ؟',
'  اسم دايم ع بالك ؟',
'  شوكت تعدل روتينك ؟',
'  موقف لاتحسد عليه ؟',
'  متى يظهر الشخص ع حقيقته ؟',
'  ( لاتغلط غلطتي ) لمن تقولها ؟',
'  من انصار دولمه ولا مندي ؟',
'  كم مره ضربت محاظرات ورحت علمود بطنك ؟',
'  لو فرضنا للحياه لون كيف سيكون لون حياتك ؟',
'  من محبين قصص الواتباد ولا واقعي ؟',
'  الصديق بشكل عام ماهو بنضرك ؟',
'  نسبه رضاك عن الناس الي بحياتك من 10 ؟',
'  كم نسبه الملل عندك الان من 10 ؟',
'  تخرجت ولا باقي لك وقت ؟',
'  لو فرضنا انا من فعل اخر مشكله بحياتك ردك الي ؟',
'  اوصف الي حولك بكلمه ؟',
'  اخر مره بكيت ؟',
'  يهمك رأي الناس فـ ملابسك وتصرفاتك ؟',
'  ما هي أجمل سنة عشتها بحياتك؟',
'  تكره المقابل او المتحدث عندما.... ؟',
'  كنت السبب في أذى شخص ما؟',
'  متى تكره نفسك ؟',
'  هل رأي الآخرين مهم بالنسبة لك؟',
'  نحن في زمن الغدر والتكبر والانكسار هل تتفق بهذه المقوله ؟',
'  هل تملك صديق يتقن الغناء؟',
'  يهمك تفاصيل ومواصفات شريكك ؟',
'  ما هي اللعبة المفضلة لديك؟',
'  ما هي مواصفات شريك حياتك؟',
'  لو اخترنا اسم ( تالا ) ڪ احد اسماء للتوأم ماذا يكون اسم الثاني ؟',
'  هل يُمكن أن تكذب كذبة كبيرة للخروج من مأزق؟',
'  انت من محبين الماضي والذكريات ولا الحاظر والتخطي ؟',
'  ماذا لو لم يتم اكتشاف جبر الخواطر ؟',
'  صاحبك ولا حبيبك ؟',
'  إذا جاء شريك حياتك وطلب الانفصال، فماذا يكون ردك وقتها؟',
'  اول شي يخطر في بالك اذا سمعت كلمه بغداد ؟',
'  هل أنت شخص غيور؟',
'  تطبيق يعدل مزاجك عندما تتصفحه ؟',
'  كلمه لاخر شخص خرج حياتك ؟',
'  انت تدرس؟',
'  ‏ماذا ستختار من الكلمات لتعبر لنا عن حياتك التي عشتها الى الآن؟',
...
local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
    {{text = "⦗ اضغط للانضمام للعبه ⦘" , data = "Ahkam/"..Anubis}}
  }
}
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/GifFast/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/MemzFast/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/RemixFast/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/PhotosFast/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/AnimeFast/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/MoviesFast/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/SeriesFast/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
...
if text == "تغير اسم البوت" or text == "⦗ تغير اسم البوت⦘" then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
...
Redis:del(Fast.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح تعديلاتي')
...
data = {
{
{text = '⦗ اي ⦘', data = msg_user_send_id.."hms"..testhms},{text = '⦗ لا ⦘', data = msg_user_send_id.."nn_hnss"..testhms}
},
}
}
...
keyboard.inline_keyboard = {
{
{text = '⦗حول البوت⦘', callback_data = msg.sender_id.user_id..'/zxhaut'},{text = '⦗توب الفلوس⦘',  callback_data = msg.sender_id.user_id..'/topmon'},
},
{
{text = Name_dev, url = "t.me/"..UName_dev },
},
...
if text == "⦗ تفعيل البوت بالصوره ⦘" then
  if not msg.Asasy then
  bot.sendText(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
  end
...
if text == "⦗ تعطيل البوت بالصوره ⦘" then
if not msg.Asasy then
bot.sendText(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
...
if text == '⦗ مسح ڪليشه لـ Start ⦘' then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == '⦗ تغير ڪليشه المطور ⦘' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
