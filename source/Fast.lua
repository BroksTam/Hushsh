...
elseif Ownerss then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."PresidentQ:Group:Reply"..ChatId) or  'المالك'
elseif SuperCreator then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."President:Group:Reply"..ChatId) or 'منشئ الاساسي '
elseif Creator then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."Constructor:Group:Reply"..ChatId) or 'منشئ'
elseif Manger then
...
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or Redis:get(Fast.."Mempar:Group:Reply"..ChatId) or 'عضو'
end  
return Status
end 
...
{
{text = '⦗ رفع منشئ اساسي ⦘'..SuperCreatorz, data =user..'/statusSuperCreatorz/'..useri},{text = '⦗ رفع منشئ ⦘'..Creatorz, data =user..'/statusCreatorz/'..useri},
},
{
{text = '⦗ رفع مدير ⦘ '..Mangerz, data =user..'/statusMangerz/'..useri},{text = '⦗ رفع ادمن ⦘'..Adminz, data =user..'/statusAdminz/'..useri},
},
{
{text = '⦗ رفع مميز ⦘'..Specialz, data =user..'/statusSpecialz/'..useri},
},
{
...
if text == 'كروبات البوت' or text == 'كروبات البوت' or text == 'روابط الكروبات' then
if not msg.Asasy then 
...
if text == 'المعلومات ' or text == 'معلومات التنصيب البوت' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id,"\n*↯︙ عذرآ البوت ليس ادمن في الكروب يرجى ترقيته واعطاء الصلاحيات ! *","md",true)  
end
...
send(Sudo_Id,0,'*\n↯︙ تم تفعيل كروب جديد \n↯︙من قام بتفعيلي : {*['..UserInfo.first_name..'](tg://user?id='..msg.sender_id.user_id..')*} \n↯︙معلومات الكروب :\n↯︙عدد الاعضاء : '..Info_Chats.member_count..'\n↯︙عدد الادمنيه : '..Info_Chats.administrator_count..'\n↯︙عدد المطرودين : '..Info_Chats.banned_count..'\n↯︙ عدد المقيدين : '..Info_Chats.restricted_count..'*',"md",true, false, false, false, reply_markup)
end
Redis:sadd(Fast.."ChekBotAdd",msg_chat_id)
...
return send(msg_chat_id,msg_id,"\n*↯︙ عذرا انت لست ادمن او مالك الكروب *","md",true)  
end
...
send(Sudo_Id,0,'*\n↯︙ تم تعطيل كروب جديد لدى البوت \n↯︙من قام بتعطيلي : {*['..UserInfo.first_name..'](tg://user?id='..msg.sender_id.user_id..')*} \n↯︙معلومات الكروب :\n↯︙عدد الاعضاء : '..Info_Chats.member_count..'\n↯︙عدد الادمنيه : '..Info_Chats.administrator_count..'\n↯︙عدد المطرودين : '..Info_Chats.banned_count..'\n↯︙ عدد المقيدين : '..Info_Chats.restricted_count..'*',"md",true, false, false, false, reply_markup)
end
...
Text = " قائمه ترند الكروب الاول بلتفاعل : \n\n"
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{
{text = '⦗ رفع منشئ اساسي ⦘ '..SuperCreatorz, data =senderr..'/statusSuperCreatorz/'..UserId_Info.id},{text = '⦗ رفع منشئ ⦘ '..Creatorz, data =senderr..'/statusCreatorz/'..UserId_Info.id},
},
{
{text = '⦗ رفع مدير ⦘ '..Mangerz, data =senderr..'/statusMangerz/'..UserId_Info.id},{text = '⦗ رفع ادمن ⦘'..Adminz, data =senderr..'/statusAdminz/'..UserId_Info.id},
},
{
{text = '⦗ رفع مميز ⦘ '..Specialz, data =senderr..'/statusSpecialz/'..UserId_Info.id},
},
{
{text = '⦗ حظر ⦘ '..BanGroupz, data =senderr..'/statusban/'..UserId_Info.id},{text = '⦗ كتم ⦘'..SilentGroupz, data =senderr..'/statusktm/'..UserId_Info.id},
},
{
{text = '⦗ تنزيل جميع الرتب ⦘', data =senderr..'/statusmem/'..UserId_Info.id},
},
{
{text = '⦗ الغاء ⦘ ', data ='/delAmr1'}
}
...
return send(msg.chat_id,msg.id,'*\n↯︙  هلا حب هاي قائمه التحكم بالمستخدم  *',"md",false, false, false, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{
{text = '⦗ رفع منشئ اساسي ⦘ '..SuperCreatorz, data =senderr..'/statusSuperCreatorz/'..rep_idd},{text = '⦗ رفع منشئ ⦘ '..Creatorz, data =senderr..'/statusCreatorz/'..rep_idd},
},
{
{text = '⦗ رفع مدير ⦘'..Mangerz, data =senderr..'/statusMangerz/'..rep_idd},{text = '⦗ رفع ادمن ⦘ '..Adminz, data =senderr..'/statusAdminz/'..rep_idd},
},
{
{text = '⦗ رفع مميز ⦘ '..Specialz, data =senderr..'/statusSpecialz/'..rep_idd},
},
{
...
local Info_Members = bot.searchChatMembers(msg_chat_id, "*", 300)
local List_Members = Info_Members.members
listall = '\n*↯︙ قائمه الاعضاء \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(List_Members) do
local UserInfo = bot.getUser(v.member_id.user_id)
...
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ♡ تم الغاء حفظ كروبك *',"md",true)  
Redis:del(Fast..'SetGroupVip'..senderr)
return false  
end 
Redis:del(Fast..'SetGroupVip'..senderr)
Redis:set(Fast..'SOFI:Group:Vip'..senderr,text)
local text = "*♡ تم حفظ كروبك بنجاح ✅*"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text="تغيير كروبي",data="/ChangeGroupVip:"..senderr},{text="حذف كروبي",callback_data="/DelGroupVip:"..senderr}},
...
if text and text:match("^ضع كروبي$") or text and text:match("^وضع كروبي$") then
if not msg.Admin then
return send(msg_chat_id,msg_id,'*\n ♡ عذرآ الامر يخص〘 '..Controller_Num(7)..' 〙*',"md",true)  
end
...
return send(msg_chat_id,msg_id,"↯︙ ارسل الصوره لوضعها للكروب","md",true)    
end
...
{
{text = '⦗ قسم التفعيل والتعطيل ⦘',type = 'text'},{text = '⦗ قسم الاذاعه ⦘ ', type = 'text'},
},
{
{text = '⦗ قسم الحظر والكتم ⦘',type = 'text'},
},
{
{text = '⦗ قسم ملفات السورس ⦘',type = 'text'},{text = '⦗ قسم الاشتراك الاجباري ⦘',type = 'text'},
},
{
{text = '⦗ قسم السورس ⦘',type = 'text'},
},
