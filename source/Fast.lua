...
ControllerAll = false
local ListSudos = {Sudo_Id,2100004938,3333333333,627658332,5986905034,6430417482,55555555555,5555555555}
...
elseif tonumber(senderr) == 3333333333 then
msg.Name_Controller = 'مطور السورس -  '
msg.The_Controller = 1
...
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(3333333333) then
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/XX_kato/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
end
