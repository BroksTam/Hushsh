...
MsgText = 'شدو حيلكم' 
elseif tonumber(Message) < 1000 then 
MsgText = ' خوش تتحجون ستمرو' 
elseif tonumber(Message) < 1300 then 
MsgText = ' استمرو ابطالي ' 
elseif tonumber(Message) < 1600 then 
MsgText = ' بلشتو تحجون'  
elseif tonumber(Message) < 1800 then 
MsgText = 'استمر يعسل ' 
...
data = {
{
{text = '- قناه السورس', url = 'http://t.me/ioutb'}, {text = '- مطور السورس', url = 't.me/QQQQ7o"}, 
},
{
