...
MsgText = '⦗ لاتفاعل ولا اخلاق ⦘'
elseif tonumber(Message) < 200 then 
MsgText = '⦗ متشد شويه نفسك بلتفاعل ⦘'
elseif tonumber(Message) < 400 then 
MsgText = '⦗ بلشت تتفاعل هسه صرت احبك ⦘'
...
MsgText = '⦗ شده حبيبي همم نفسك بلتفاعل ⦘'
elseif tonumber(Message) < 5500 then 
MsgText = '⦗ عمي مخرب الجو والاجواء بتفاعلك ⦘'
elseif tonumber(Message) < 7000 then 
MsgText = '⦗ حارك الكروب حبيبي انته تستاهل رتبه ⦘
elseif tonumber(Message) < 9500 then 
MsgText = '⦗ نزوجك ع هلتفاعل الله عليك ⦘'
...
return send(msg_chat_id,msg_id,"↯︙ اضغط لارسال همسه لـ "..first_name.." ","html",true,false,false,false,reply_markup) 
end
end
end
