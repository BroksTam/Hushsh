...
{
{text = 'تعطيل غنيلي 
', data = senderr..'/'.. 'unmute_knile'},{text = 'تفعيل غنيلي', data = senderr..'/'.. 'mute_knile'},
},
{
...
local Mostafa = {
'↯ ︙ ها حبي شبيك شرايد من زربان ؟',
'↯ ︙ تفضل بويه احجي شتريد .',
'↯ ︙ يعني اليوم وتالي اكضيه وياك بس ها شتريد ؟',
'↯ ︙ بسرعه احجي شتريد مشغول ترا',
'↯ ︙ لخاطر الله مامليت بس كاضيه كلشوي تكتب بوت ترا مليت .',
'↯ ︙ شرايود مني ؟',
'↯ ︙ها يابعد صوت '..NamesBot..' ؟',
}
...
if Redis:get(Fast.."name bot type : ") == "photo" then
    ...
    if photo.total_count > 0 then
     ...
     "↯ ︙اسمي "..NamesBot.." يبن الجلب",
      ...
      "↯ ︙هو يوم نكضيه بس هيج ؟",
      "↯ ︙اسمي "..NamesBot.." ياحبيبي",
      "↯ ︙عود تصيحلي بوت علساس متعرف اسمي ؟"
