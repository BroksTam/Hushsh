...
data = {
{
{text = '- العاب السورس', data = msg.sender_id.user_id..'/normgm'}, {text = '- العاب متطوره', data = msg.sender_id.user_id..'/degm'}, 
},
{
...
return send(msg_chat_id,msg_id,' ↯︙اهلا بك عزيزي المطور  \n اضغط على  ⦗ *القسم*⦘  المراد ، ↯︙ ', 'md', false, false, false, false, reply_markup)
...
elseif text == '⦗ قسم اعدادات البوت ⦘' then

local reply_markup = bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = '⦗ تفعيل البوت بالصوره ⦘',type = 'text'},{text = '⦗ تعطيل البوت بالصوره ⦘', type = 'text'},
},
{
{text = '⦗ تغير ڪليشه المطور ⦘',type = 'text'},{text = '⦗ مسح ڪليشه المطور ⦘', type = 'text'},
},
{
{text = '⦗ تغير ڪليشه لـ Start ⦘',type = 'text'},{text = '⦗ مسح ڪليشه لـ Start ⦘', type = 'text'},
},
{
{text = '⦗ تغير اسم البوت⦘',type = 'text'},{text = '⦗ مسح اسم البوت⦘', type = 'text'},
},
{
...
return send(msg_chat_id,msg_id,'↯ ︙ اهلا بك عزيزي المطور الاساسي \n↯ ︙ إليك قسم ⦗ *اعدادات البوت* ⦘ اختر المراد  ', 'md', false, false, false, false, reply_markup)
...
{
{text = '⦗ المجموعات ⦘',type = 'text'},{text = '⦗ المشتركين⦘', type = 'text'},
},
{
...
{
{text = '⦗ المنشئين ⦘',type = 'text'},{text = '⦗  المنشئين الاساسين ⦘', type = 'text'},
},
{
{text = '⦗  المميزين ⦘',type = 'text'},{text = '⦗  الادمنيه⦘', type = 'text'},
},
{
{text = 'لاتظغط هنا موشغلك !',type = 'text'},
},
{
{text = '⦗ رجوع ⦘',type = 'text'},
},
...
{
{text = '⦗ تفعيل جلب النسخه الاحتياطيه⦘',type = 'text'},{text = '⦗تعطيل جلب النسخه الاحتياطيه⦘', type = 'text'},
},
{
{text = '⦗ رجوع ⦘',type = 'text'},
},
...
data = {
{
{text = '⦗المكتومين العام⦘',type = 'text'},{text = '⦗المحظورين العام⦘', type = 'text'},
},
{
...
return send(msg_chat_id,msg_id,'↯ ︙ اهلا بك عزيزي المطور الاساسي  \n↯ ︙ إليك قسم ⦗ *اعدادات البوت* ⦘ اختر المراد  ', 'md', false, false, false, false, reply_markup)
elseif text == '⦗ قسم اشتراك اجباري ⦘' then

local reply_markup = bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = '⦗الاشتراك لاجباري⦘',type = 'text'},{text = '⦗تغير الاشتراك الاجباري⦘',type = 'text'},
},
{
{text = '⦗تفعيل الاشتراك الاجباري⦘',type = 'text'},{text = '⦗تعطيل الاشتراك الاجباري⦘',type = 'text'},
},
{
{text = '⦗تفعيل وضع اشتراك الاعضاء⦘',type = 'text'},{text = '⦗تعطيل وضع اشتراك لاعضاء⦘',type = 'text'},
},
{
{text = 'الغاء',type = 'text'},
},
...
return send(msg_chat_id,msg_id,'↯ ︙ اهلا بك عزيزي المطور الاساسي  \n↯ ︙ إليك قسم ⦗ *اعدادات البوت* ⦘ للبوت  ', 'md', false, false, false, false, reply_markup)
elseif text == '⦗ قسم الاحصائيات ⦘' then
...
{
{text = 'لاتبعص هنا موشغلك !',type = 'text'},
},
{
{text = '⦗ رجوع ⦘',type = 'text'},
},
...
return send(msg_chat_id,msg_id,'↯ ︙ اهلا بك عزيزي المطور الاساسي  \n↯ ︙ إليك قسم ⦗ *اعدادات البوت* ⦘ اختر المراد  ', 'md', false, false, false, false, reply_markup)
elseif text == '⦗ قسم تفعيل وتعطيل ⦘' then
...
{
{text = '⦗ تفعيل جلب النسخه التلقائيه⦘',type = 'text'},{text = '⦗تعطيل جلب النسخه التلقائه⦘', type = 'text'},
},
{
{text = '⦗ رجوع ⦘',type = 'text'},
},
...
{
{text = 'لاتبعص هنا مو شغلك !',type = 'text'},
},
{
{text = '⦗ رجوع ⦘',type = 'text'},
},
...
return send(msg_chat_id,msg_id,'↯ ︙ اهلا بك عزيزي المطور الاساسي  \n↯ ︙ إليك قسم ⦗ *اعدادات البوت* ⦘ اختر المراد  ', 'md', false, false, false, false, reply_markup)
elseif text == '⦗ قسم ملفات السورس ⦘' then
...
return send(msg_chat_id,msg_id,'↯ ︙ اهلا بك عزيزي المطور الاساسي  \n↯ ︙ اليك قسم ⦗ *اعدادات البوت* ⦘ اختر المراد  \n *احذر وتأكد من ان جميع الملفات مفعله* ', 'md', false, false, false, false, reply_markup)
elseif text == '⦗ قسم السورس ⦘' then

local reply_markup = bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = '⦗تعين قناة السورس⦘',type = 'text'},{text = '⦗تعين مطور السورس⦘', type = 'text'},
},
{
{text = '⦗تعين رمز السورس⦘',type = 'text'},{text = '⦗مسح رمز السورس⦘',type = 'text'},
},
{
{text = '⦗السورس⦘',type = 'text'},
},
{
{text = '⦗قناة السورس⦘',type = 'text'},{text = '⦗مبرمج السورس⦘', type = 'text'},
},
{
{text = 'لاتبعص هنا موشغلك !',type = 'text'},
},
...
{
{text = 'لاتعبص هنا موشغلك !',type = 'text'},
},
{
{text = '⦗ رجوع ⦘',type = 'text'},
},
