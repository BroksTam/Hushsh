...
local Textingt = {"الحلوابن الحلو", "احسك طامس", "تعال تفاعل", "تحبني لو احبك", "شلونك يحلو", "شو متبين", "كالو تحب", "شكد حات", "شو احسك تحلو", "احبك حب", "نتتخاصص", "اعشقك يحلو", "تحبني لوتحب جلب", "عوف لخاص", "تعال يمعود", "تعال خلحبك", "ممكن بوسه", "جميلي انت", "احبك تحبني؟", "ابوسك", "فد بوسه", "اجيك لوتجيني", "نايم مو", "شعدك صافن", "كالو متحبني", "تع هنا", "نزحفلك", "بيتكم وين", "خلحبك", "اموتبيك", "تاجي انت", "الحلو مالكروب", "فصعون", "حلك تعال", "😕", "🙁", "😣", "😖", "😫", "😩", "🥺", "😢", "😭", "😤", "😠", "😡", "🤯", "😳", "🥵", "🥶", "😱", "😨", "😰", "😥", "😓", "🤗", "🤔", "🤭", "🤫", "🤥", "😶", "😐", "😑", "😬", "🙄", "😯", "😦", "😧", "😮", "😲", "🥱", "😴", "🤤", "😪", "😵", "🤐", "🥴", "🤢", "🤮", "🤧", "😷", "🤒", "🤕", "🤑", "🤠", "😈", "👹", "👺", "🤡",}
...
return send(msg_chat_id,msg_id,GetByName(msg).."↯︙ تم تعطيل الالعاب من قبل","md",true )
end
if text == 'جمل' then
...
local Message = v
if Message then
t = "↯︙ تدلل مسحت ( "..k.." ) من المتحركات"
bot.deleteMessages(msg.chat_id,{[1]= Message})
Redis:del(Fast.."Fast:all:anim"..msg.chat_id)
end
end
if #list == 0 then
t = "↯︙ لا يوجد متحركات في القروب"
end
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '↯︙ من ['..UserInfo.first_name..'](tg://user?id='..msg.sender_id.user_id..')\n'
send(msg.chat_id,msg.id, Teext..t,"md",true)
