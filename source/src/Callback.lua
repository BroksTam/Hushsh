...
data = {
{
{text = '⦗ تحديثات البوت ⦘', url = 'https://t.me/Broks_UP'}, 
},
}
}
...
return bot.answerCallbackQuery(data.id,"\n↯︙ انته صاحب السؤال حبيبي شلون تلعب وياهم", true)
end
...
data = {
{
{text = '⦗ انضمام ⦘ ', data = Game_king..'/add7azer'}, 
},
{
...
type = 'inline',
data = {
{{text="⦗ تغير اسمي ⦘",data="/ChangenameVip:"..IdUser},{text="⦗ حذف اسمي ⦘",data="/deletename:"..IdUser}},
...
type = 'inline',
data = {
{{text="⦗ تغير عمري ⦘",data="/ChangeSunniVip:"..IdUser},{text="⦗ حذف عمري ⦘",data="/deleteSunni:"..IdUser}},
{{text="⦗ وضع اسمي ⦘",data="/ChangenameVip:"..IdUser}},
...
type = 'inline',
data = {
{{text="⦗ تغير بوتي ⦘",data="/ChangeBotVip:"..IdUser},{text="⦗ حذف بوتي ⦘",data="/DelBotVip:"..IdUser}},
...
type = 'inline',
data = {
{{text="⦗ تغير كروبي ⦘",data="/ChangeGroupVip:"..IdUser},{text="⦗ حذف كروبي ⦘",data="/DelGroupVip:"..IdUser}},
{{text="⦗ وضع بوتي ⦘",data="/ChangeBotVip:"..IdUser}},{{text="⦗ وضع قناتي ⦘",data="/ChangeChanneVip:"..IdUser}},
...
type = 'inline',
data = {
{{text="⦗ تغير قناتي ⦘",data="/ChangeChanneVip:"..IdUser},{text="⦗ حذف قناتي ⦘",data="/DelChanneVip:"..IdUser}},
...
data = {
{
{text = '⦗ النوادي ⦘', data = data.sender_user_id..'/topnade'},{text = '⦗ الزرف ⦘', data = data.sender_user_id..'/topzrf'},{text = '⦗ الفلوس ⦘', data = data.sender_user_id..'/topmon'},{text = '⦗ الزواج ⦘', data = data.sender_user_id..'/zoztee'},
},
{
...
data = {
{
{text = '⦗ عرض همسه ⦘', data = "sender:"..testhms[1].."to:"..to_id.."hmsa:"..testhms[2]}
},
}
}
send(chat_id,msg_id,"↯︙الحلو  ["..to_name.."](tg://user?id="..to_id..") \n↯︙ لديك همسه من   ["..sender_name.."](tg://user?id="..testhms[1]..") \n↯︙ اضغط لرؤيتها","md",true,false,false,false,reply_markup)
...
https.request("https://api.telegram.org/bot"..Token.."/answerCallbackQuery?callback_query_id="..data.id.."&text="..URL.escape("⦗ الهمسه مو الك دوده ⦘").."&show_alert=true")
end
end
...
{
{text = '⦗ بدء اللعبه ⦘', data = '/startjoinerolet'},
},
}
}
...
local zwg_id = anubis[2]
if tonumber(zwga_id) == tonumber(IdUser) then
return edit(ChatId, Msg_id, "لعد شوكت حتزوجين متكليلي","md",false)
end
end
if Text and Text:match('(%d+)/zeng') then
local UserId = Text:match('(%d+)/zeng')
...
keyboard.inline_keyboard = {
{
{text = 'اغنيه اخرى', callback_data=IdUser.."/songg"},
},
}
...
keyboard.inline_keyboard = {
{
{text = '⦗ صورتي التاليه ⦘', callback_data=IdUser.."/sorty"..next..""},{text = '⦗ صورتي السابقه ⦘', callback_data=IdUser.."/sorty"..prev..""},
},
}
local mm = Msg_id/2097152/0.5
...
Textk = 'انت ⇿ ✂️\nسورس البروكس ⇿ ✂️\nالنتيجة ⇿ سورس البروكس ⚖️ '..bain..'\n↯︙'
elseif Descriptioont == "2" then
Textk = 'انت ⇿ ✂️\nسورس البروكس ⇿ 🪨️\nالنتيجة ⇿ 🏆 سورس البروكس 🏆\n↯︙'
else
Textk = 'انت ⇿ ✂️\nسورس البروكس ⇿ 📄️\nالنتيجة ⇿ 🏆 '..bain..' 🏆\n↯︙'
end
local reply_markup = bot.replyMarkup{
...
elseif Text and Text:match('(%d+)/fwd') then
local UserId = Text:match('(%d+)/fwd')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{
{text = '⦗ قفل فقط ⦘', data =UserId..'/'.. 'lock_fwd'},{text = '⦗ بالكتم ⦘', data =UserId..'/'.. 'lock_fwdktm'},
},
{
{text = '⦗ بالطرد ⦘', data =UserId..'/'.. 'lock_fwdkick'},{text = '⦗ بالتقيد ⦘', data =UserId..'/'.. 'lock_fwdkid'},
},
{
{text = '⦗ فتح فقط ⦘', data =UserId..'/'.. 'unlock_link'},
},
{
{text = '⦗ رجوع ⦘', data =UserId..'/'.. 'NoNextSeting'},
},
...
edit(ChatId,Msg_id,"- اختار الان نوع قفل على امر التوجيه", 'md', true, false, reply_markup)
end
...
if Text and Text:match('(.*)/promot_mmez/(.*)') then
  ...
  local sender_id = anubis[1]
  local rtba_name = anubis[2]
  if tonumber(sender_id) == tonumber(IdUser) then
  Redis:sadd(Fast.."rowtab:", rtba_name)
  Redis:set(Fast..rtba_name.."type:", "mmez")
  Redis:del(Fast.."Set:rtba"..sender_id..":"..ChatId)
