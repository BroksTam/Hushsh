...
{{text = '𝐂𝐀𝐄𝐒𝐀𝐑 • 𝐒𝐎𝐔𝐑𝐂𝐄', url = "https://t.me/COURSE_CAESAR"}},
}
}
...
if Text and Text:match('(%d+)/play_wheel') then
  ...
  keyboard.inline_keyboard = {
  {
  {text = '✦ َ𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐀𝐄𝐒𝐀𝐑✦',url="t.me/COURSE_CAESAR"}, 
  },
  }
  local msg_reply = msg_id/2097152/0.5
...
{
{text = '𝐂𝐀𝐄𝐒𝐀𝐑 • 𝐒𝐎𝐔𝐑𝐂𝐄', url="t.me/COURSE_CAESAR"},
},
}
}
...
type = "photo",
media = ph,
caption = '*  *[آهــلٓآ بَٰــڪ فٍُــيَ س๋͜‏ــۄرس๋͜‏ قيصر 🕷️🔥](t.me/COURSE_CAESAR)*\n\n*[ آقٍُـۄيَ مــصَٰـآنــعَِٰ س๋͜‏ــۄࢪس๋͜‏ــآټِٖ عَِٰــلٓيَ آلٓټِٖـلٓيَـج ـࢪآم](t.me/COURSE_CAESAR) *\n\n*[ س๋͜‏ؤࢪس๋͜‏ قيصر عَِٰلٓيَ منعَِٰ ټِٖصَٰفٍُيَه آلٓمج ـمۄعَِٰآټِٖ ۄح ـمآيَټِٖهآ](t.me/COURSE_CAESAR)*\n\n*[ لٓــديَــنــآ ټِٖـنصَٰيَــبَٰ بَٰـۄټِٖــآټِٖ مــيَـۄزڪ آيَــضَِٖـآ](t.me/COURSE_CAESAR)*\n\n*[لٓديَــنآ ټِٖنـصَٰيَــبَٰ ح ـس๋͜‏ــآبَٰــآټِٖ ټِٖــلٓيَــثُِٖــۄن](t.me/COURSE_CAESAR) *\n\n*[آلٓس๋͜‏ۄࢪس๋͜‏ مزۄد بَٰج ـميَعَِٰ آلآلٓعَِٰآبَٰ ۄآلٓمميَزآټِٖ آلٓمټِٖطِٖۄࢪه](t.me/COURSE_CAESAR) *\n\n*[ټِٖآبَٰعَِٰ قٍُنآه آلٓټِٖح ـديثُِٖآټِٖ ۄآلٓټِٖطِٖۄيَࢪآټِٖ لٓيَصَٰلٓڪ ڪلٓ ج ـديَد لٓديَنآ](t.me/c_a_s_e_r_h) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
type = "photo",
media = ph,
caption = '[ 𖥔━═━═━═━ٰٰ𓆩⸤𝐂𝐀𝐄𝐒𝐀𝐑⸥𓆪═━═━═━𖥔 ](t.me/COURSE_CAESAR) \n [ 🤖┇⌯ ⋆⃟➼𝐂𝐀𝐄𝐒𝐀𝐑 𝙎𝙊𝙐𝙍𝘾𝙀 ꕸ ˹🕷️🔥˼⁩](t.me/COURSE_CAESAR) \n [ ⚙️┇⌯ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ](t.me/sorescaser) \n [ 🏑┇⌯ [˚₊· ͟͟͞͞➳❥❬ ғɪʟᴇs 𝚁𝚉 𝚂𝙾𝚄𝚁𝙲𝙴 ❭• °](t.me/COURSE_CAESAR) \n [ 🏅┇⌯ • !! 𝙳𝙴𝚅 𝚂𝙾𝚄𝚁𝙲𝙴ᵛ͢ᵎᵖ ](t.me/c_a_s_e_r_h) \n [𖥔━═━═━═━ٰٰ𓆩⸤𝐂𝐀𝐄𝐒𝐀𝐑⸥𓆪═━═━═━𖥔](t.me/COURSE_CAESAR) \n [𖥔 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻  𝑺𝑶𝑼𝑹𝑪𝑬 ⏎](t.me/COURSE_CAESAR) \n\n',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = 'اضف البوت في مجموعتك !', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
}
local TextHelp = [[*
...
data = {
{
{text = 'العاب السورس', data = IdUser..'/normgm'}, {text = 'العاب اونلاين  ', data = IdUser..'/degm'}, 
},
{
...
{
{text = 'اضغط هنا لعرض اوامر السورس', data = IdUser..'/helpall'},
},
{
{text = '- 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.', url = 't.me/'..chsource..''}, 
},
{
{text = 'اضغط هنا لاضافه البوت في مجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
}
local TextHelp = [[*
↯ ︙ اهلا بك في قسم الألعاب المتطوره   
↯︙اختار اللعبه الي انت عايزها 
↯︙أختر اللعبة ثم اختار المحادثه  .
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
↯  ︙ اهلا بك في ألعاب البوت 
↯ ︙ اختار اللعبه الي انت عايزها 
↯ ︙لعبة البنك » بنك الحظ
↯ ︙لعبة مريم » رعب
↯ ︙لعبه ترجمه » ترجمه عربي 
...
local TextHelp = [[*
︙اوامر التسليه كالاتي:︙اوامر التسليه كالاتي: 
----------------------------
