...
local txt = '↯︙ بواسطه 「 ['..UserInfo.first_name..'](tg://user?id='..who_promot..')⁪⁬‌‌‌‌ 」\n↯︙  تم تفعيل الكروب ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') تلقائياً\n '
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
return bot.answerCallbackQuery(data.id,"\n↯︙ انت صاحب السؤال حبيبي ميصير تلعب وياهم ! ", true)
end
...
return bot.editMessageText(ChatId,Msg_id,'↯︙ تم مسح اللعبه الحاليه بنجاح', 'md', false, false)
else
return bot.answerCallbackQuery(data.id,"\n↯︙ الامر ليس لك", true)
end
end
...
{
{text = '- اسماء كروبات وقنوات 🪁', data = IdUser..'/faou'},
},
{
...
caption = 'المطي دا '..tag..' هو الي قتلها',
parse_mode = "Markdown"
}
local keyboard = {}
...
{{text="وضع عمري",data="/ChangeSunniVip:"..IdUser}},
...
if text =='الغاء' then 
edit(ChatId,Msg_id, '* ↯︙ تم الغاء حفظ عمرك  *',"md",true)  
Redis:del(Fast..'SetSunniVip'..IdUser)
return false  
end 
Redis:del(Fast..'SetSunniVip'..IdUser)
Redis:set(Fast..'Game:Sunni'..IdUser,text)
local text = "* ↯︙ تم حفظ عمرك *"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text="تغيير عمري",data="/ChangeSunniVip:"..IdUser},{text="حذف عمري",data="/deleteSunni:"..IdUser}},
{{text="وضع اسمي",data="/ChangenameVip:"..IdUser}},
...
if tonumber(UserId) == tonumber(IdUser) then
edit(ChatId,Msg_id,"* ↯︙تم اخفاء الامر*","md",true)
else
...
local Text = "* ↯︙ حسنا ارسل لي كروبك الان *"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if text =='الغاء' then 
edit(ChatId,Msg_id, '* ↯︙ تم الغاء حفظ كروبك  *',"md",true)  
Redis:del(Fast..'SetGroupVip'..IdUser)
return false  
end 
Redis:del(Fast..'SetGroupVip'..IdUser)
Redis:set(Fast..'SOFI:Group:Vip'..IdUser,text)
local text = "* ↯︙ تم حفظ كروبك *"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text="تغيير كروبي",data="/ChangeGroupVip:"..IdUser},{text="حذف كروبي",data="/DelGroupVip:"..IdUser}},
{{text="وضع بوتي",data="/ChangeBotVip:"..IdUser}},{{text="وضع قناتي",data="/ChangeChanneVip:"..IdUser}},
...
if text =='الغاء' then 
edit(ChatId,Msg_id, '* ↯︙ تم الغاء حفظ قناتك   *',"md",true)  
Redis:del(Fast..'SetChanneVip'..IdUser)
return false  
end 
Redis:del(Fast..'SetChanneVip'..IdUser)
...
{{text="وضع بوتي",data="/ChangeBotVip:"..IdUser}},{{text="وضع كروبي",data="/ChangeGroupVip:"..IdUser}},
...
return edit(ChatId,Msg_id,"خليج عانس ؟؟", 'md', false)
end
end
----
...
if Text and Text:match('(%d+)/play_wheel') then
  ...
  local media = {
    {
      "https://t.me/c_r_o_z_a/3","مبروك ربحت 10000000 دولار 💵","10000000"
    },
    {
      "https://t.me/c_r_o_z_a/3","مبروك ربحت 5000000 دولار 💵","5000000"
    },
    {
      "https://t.me/c_r_o_z_a/3","مبروك ربحت 1000000 دولار 💵","1000000"
    },
    {
      "https://t.me/c_r_o_z_a/3","مبروك ربحت 100000 دولار 💵","100000"
    },
    {
...
msalm = "↯︙ وسوينا لك حساب في بنك بروكس 🏦\n↯︙ وشحنالك 50 دولار 💵 هدية\n\n↯︙ رقم حسابك ↢ ( `"..cccall.."` )\n↯︙ نوع البطاقة ↢ ( "..ccctype.." )\n↯︙ فلوسك ↢ ( 50 دولار 💵 )\n↯︙ شخصيتك : "..shakseshakse.."\n↯︙ دولتك : 🇸🇾"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
return bot.editMessageText(chat_id,msg_id, "↯︙ ماتكدر تشتري فلوسك مش مكفيه","md",true)
end
...
return edit(ChatId,Msg_id, "↯︙ ماتكدر تشتري اللاعب فلوسك ماتكفي","md",true)
end
...
return edit(ChatId,Msg_id, "↯︙ ماتكدر تشتري فلوسك ماتكفي","md",true)
end
...
return edit(ChatId,Msg_id, "↯︙ فلوسك قليلة ماتكدر تضمن\n𔔁","md",true)
...
ttshakse = '↯︙ وصل ضمان 25%\n\n↯︙ مبلغ الضمان : '..convert_monyy..' دولار 💵\n↯︙ رصيدك الان : `'..convert_mony..'` دولار 💵\n𔔁'
edit(ChatId,Msg_id,ttshakse, 'md', true)
end
end
...
{
{text = 'مطور الملف', url = 'http://t.me/IOUTB'},
},
}
}
...
local zwg_id = anubis[2]
if tonumber(zwga_id) == tonumber(IdUser) then
return edit(ChatId, Msg_id, " هسه منين اجيبلك بعد حته تتزوج  ؟؟","md",false)
end
end
------
...
type = "photo",
media = ph,
caption = '*  *[ - اهلا بك عزيزي في بوت سورس ⦗ BrOkS ⦘.](t.me/  IOUTB)*\n\n*[ - يتميز البوت حذف الاباحي منع تصفيه الاعضاء من المخربين](t.me/  IOUTB) *\n\n*[ - اقوى بوت من حيث الحمايه والالعاب المتطوره](t.me/  IOUTB)*\n\n*[ - البوت يعمل ب ازرار شفافه وتفعيله تلقائي وسهل](t.me/  IOUTB)*\n\n*[- ارفع مشرفين كروبك من البوت ولذلك لمنع تصفيه الاعضاء](t.me/  IOUTB) *\n\n*[- يمكنك انت ك مالك كروب وضع قناتك اشتراك اجباري لكروبك](t.me/  IOUTB) *\n\n*[- فقط هاذا البوت تابع للسورس تاكد اولا لمنع الانتحال](t.me/IOUTB) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⦗  لتنصيب بوت خاص بك  ⦘', url = "https://t.me/FFMRD"}
},
{
{text = '⦗  رجوع  ⦘', callback_data=IdUser..'/halo'},
},
{
...
type = "photo",
media = ph,
caption = '[ 𖥔━═━═━═━ٰٰ𓆩⸤𝐂𝐀𝐄𝐒𝐀𝐑⸥𓆪═━═━═━𖥔 ](t.me/  IOUTB) \n [ 🤖┇↯︙ ⋆⃟➼𝐂𝐀𝐄𝐒𝐀𝐑 𝙎𝙊𝙐𝙍𝘾𝙀 ꕸ ˹🕷️🔥˼⁩](t.me/  IOUTB) \n [ ⚙️┇↯︙ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ](t.me/sorescaser) \n [ 🏑┇↯︙ [˚₊· ͟͟͞͞➳❥❬ ғɪʟᴇs 𝚁𝚉 𝚂𝙾𝚄𝚁𝙲𝙴 ❭↯︙ °](t.me/  IOUTB) \n [ 🏅┇↯︙ ↯︙ !! 𝙳𝙴𝚅 𝚂𝙾𝚄𝚁𝙲𝙴ᵛ͢ᵎᵖ ](t.me/loutb) \n [𖥔━═━═━═━ٰٰ𓆩⸤𝐂𝐀𝐄𝐒𝐀𝐑⸥𓆪═━═━═━𖥔](t.me/  IOUTB) \n [𖥔 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻  𝑺𝑶𝑼𝑹𝑪𝑬 ⏎](t.me/  IOUTB) \n\n',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
type = "photo",
media = ph,
caption = '*  *[ - اهلا بك عزيزي مره اخرى في البوت .](t.me/  IOUTB)*\n*[ - لتفعيل البوت ارفعه مشرف وكامل صلاحيات ! ](t.me/  IOUTB) *\n*[ - بعد رفع البوت مشرف سيتفعل البوت تلقائي في مجموعتك !  ](t.me/  IOUTB)*\n*[ - اقفل وفعل الاوامر وتحكم في مجموعتك من خلال ازرار الشفافه .  ](t.me/  IOUTB)*\n*[- ارسل امر ⦗ قفل الاباحي ⦘ لمنع ارسال اي محتوى اباحي للمجموعتك ](t.me/  IOUTB) *\n*[- ارسل امر ⦗ قفل التفليش ⦘ لمنع اي تخريب في مجموعتك اي كان ](t.me/  IOUTB) *\n*[- ارسل  امر ⦗ تفعيل منع التصفيه ⦘ لمنع اي حظر عضو من المخربين مهما كانت رتبته او صلاحياته !](t.me/loutb) *\n*[- يمكنك ايضا انت كمالك كروب وضع اشتراك اجباري لمجموعتك من البوت لاي قناه كانت !](t.me/loutb) *\n*[- العاب كثيره واوامر تسليه لانهائيه ومنافسات الترند والبنك لاحدود !](t.me/loutb) *\n*[- يمكنك الان مسح مايقدر ب5000 مسج من الكروب عكس بقيه السورسات تتوقف عند حذف 1000 فقط !](t.me/loutb) *\n*[- يتميز البوت بعدم تكرار اسالئه او االعاب مثل ⦗ كت ،اسالني،احكام،صراحه،مليون ⦘ والخ..](t.me/loutb) *\n*[- تاكد من البوت والمعرف الخاص لبوتات سورس بروكس!](t.me/loutb) *\n*[- امر حذف اباحي صلاحيه الحذف ⦗ صوره،متحركه،ستيكر،ستيكر متحرك،متحركه تعبير ⦘](t.me/loutb) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⦗  حول البوت ⦘ ', callback_data=IdUser..'/zxhaut'},{text = '⦗ توب الفلوس ⦘',  callback_data=IdUser..'/lhaui'},
},
{
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/c_r_o_z_a/15", caption = "↯︙ لقد وصلنا الى المنزل شكراَ جزيلَ انتظرني ثواني وسوف اعود🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = ' ⸢ 𝒖𝒑𝒅𝒂𝒕𝒆 ↯︙ 𝒃𝒐𝒕 ⸥ ', url="t.me/  IOUTB"},
},
}
}
local TextHelp = [[*
...
{
{text = '- البنك', data = IdUser..'/mounybank'}, 
},
{
{text = '   - 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.', url = 't.me/IOUTB'}, 
},
...
{
{text = '- اوامر السورس', data = IdUser..'/helpall'},
},
{
{text = '   - 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.', url = 't.me/IOUTB'}, 
},
...
{
{text = '- اضغط لاضافه البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
}
local TextHelp = [[*
↯︙  اهلا بك في قسم العاب السورس 
↯︙  اختار اللعبه الي انت تريدها
— — — — — — — — —
↯︙ لعبة البنك ← بنك الحظ
↯︙ لعبة مريم ← رعب
...
↯︙ حظر كروب + { الايدي }
↯︙ غادر ← + { الايدي }
↯︙ اسم بوتك + غادر بالكروب
↯︙ تفعيل تعطيل الاشتراك الاجباري
↯︙ الاشتراك الاجباري
↯︙ تغيير الاشتراك الاجباري
↯︙ تفعيل تعطيل الاشتراك الاجباري للكروب
...
Textk = 'انت ⇿ 🪨️\n البروكس ⇿ ✂️\nالنتيجة ⇿ 🏆 '..bain..' 🏆\n↯︙'
elseif Descriptioont == "2" then
Textk = 'انت ⇿ 🪨️\ nالبروكس ⇿ 🪨️\nالنتيجة ⇿ بروكس  ⚖️ '..bain..'\n↯︙'
else
Textk = 'انت ⇿ 🪨️\n البروكس ⇿ 📄️\nالنتيجة ⇿ 🏆 بروكس  🏆\n↯︙'
end
local reply_markup = bot.replyMarkup{
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'هل تعلم اخرى ', callback_data=IdUser.."/Learn"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
if text == 'امثله' or text == 'مثال' or text == 'لعبه امثله' then
photo = "https://t.me/amthla/2"
local Name = '- هل انت جاهز للعب ؟'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '-ابدأ اللعب ', callback_data = msg.sender_id.user_id..'amthla'}
},
{
{text = '✈ • أضف البوت إلي مجموعتك • ✈', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
au ={type = "photo",media = "https://t.me/wffhvv/"..Rrr.."",caption = '*هذه لك ! *\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'تويت اخرى ', callback_data=IdUser.."/tweet"},},}
local mm = Msg_id/2097152/0.5
https.request("http://api.telegram.org/bot"..Token.."/editmessagemedia?chat_id="..ChatId.."&message_id="..mm.."&media="..JSON.encode(au).."&reply_markup="..JSON.encode(keyboard))
end 
end
...
if tonumber(IdUser) == tonumber(UserId) then
Rrr = math.random(2,4)
au ={type = "photo",media = "https://t.me/CXAXA/"..Rrr.."",caption = '*↯︙ هل تتفق علي شبيهك ؟؟*\n',parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اتفق 👍', callback_data=IdUser.."/agree"},{text = 'لا اتفق ??', callback_data=IdUser.."/noagree"},
...
if tonumber(IdUser) == tonumber(UserId) then
local txxt = '*↯︙ للاسف لم يتم التعرف من قبل البوت ❌*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'العب مره اخرى ', callback_data=IdUser.."/badnew"},
},
}
local mm = Msg_id/2097152/0.5
...
Redis:set(Fast.."Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
...
Redis:set(Fast.."Get:Reides:Commands:Group"..UserId[2]..":"..'تت','تاك للكل')
...
edit(ChatId,Msg_id,"↯︙ تم مسح منشئين الكروب", "md",true, false, reply_markup)
end
...
edit(ChatId,Msg_id,"↯︙ تم مسح ادمنيه الكروب", "md",true, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"↯︙ تم مسح جميع زوجاتك المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"↯︙ تم مسح جميع الملطلطين المجموعه", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"↯︙ تم مسح جميع لوكيه المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"↯︙ تم مسح جميع الكيك المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"↯︙ تم مسح جميع المازوخيين المجموعة", 'md', false)
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
edit(ChatId,Msg_id,"↯︙ تم مسح جميع الاغبياء الي هنا ف المجموعة", 'md', false)
end
...
elseif Text and Text:match('(%d+)/no') then
local UserId = Text:match('(%d+)/no')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = 'إعادة اللعبه', data = IdUser..'Ml'},},}}
local TextHelp = [[*↯︙  للأسف خطأ يا صديقي حظ اوفر المره القادمه *]]
...
elseif Text and Text:match('(%d+)/mthalhelp/(.*)') then
local dataa = {Text:match('(%d+)/mthalhelp/(.*)')}
local UserId , q = dataa[1] , dataa[2]
if tonumber(IdUser) == tonumber(UserId) then
local qq = Redis:get(Fast..ChatId..'Milion:help'..UserId) or 0
if tonumber(qq) < 3 then
...
elseif Text and Text:match('(%d+)amthla') then
local UserId = Text:match('(%d+)amthla')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fast..ChatId..'Milion:help'..UserId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = '- قصير', data = IdUser..'/no'},},
{{text = '- الجذب ', data = IdUser..'/no'},},
{{text = '- الكذب', data = IdUser..'MT1'},},
{{text = '- المطي', data = IdUser..'/no'},},
{{text = '- مساعده', data = IdUser..'/mthalhelp/الكذب'},},
}}
local TextHelp = [[*- حبل الـ.........صغير .*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)S1') then
local UserId = Text:match('(%d+)S1')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Fast..ChatId..'Milion:help'..UserId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = '- الفعل', data = IdUser..'/no'},},
{{text = '- العمل', data = IdUser..'no'},},
{{text = '- ذنب', data = IdUser..'/MT2'},},
{{text = 'مساعده', data = IdUser..'/mthalhelp/ذنب'},},
}}
local TextHelp = [[*- عذر اقبح من......... ؟*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)MT1') then
local UserId = Text:match('(%d+)MT1')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = 'السؤال التالي ', data = IdUser..'S1'},},}}
local TextHelp = [[*↯︙  احسنت يا صديقي إجابتك صحيحة  *]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)S2') then
local UserId = Text:match('(%d+)S2')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = '- يورثه ', data = IdUser..'/no'},},
{{text = ' - يتعلمه', data = IdUser..'/no'},},
{{text = '- شاب عليه ', data = IdUser..'/MT3'},},
{{text = '- مساعده', data = IdUser..'/mthalhelp/شاب عليه'},},
}}
local TextHelp = [[*- من شب على شيء.........؟ *]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)MT2') then
local UserId = Text:match('(%d+)MT2')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = 'السؤال التالي ', data = IdUser..'S2'},},}}
local TextHelp = [[*↯︙  احسنت يا صديقي إجابتك صحيحة  *]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)S3') then
local UserId = Text:match('(%d+)S3')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = '- ودل ', data = IdUser..'MT4'},},
{{text = '- وسحب', data = IdUser..'/no'},},
{{text = '- ونعم', data = IdUser..'/no'},},
{{text = 'مساعده', data = IdUser..'/mthalhelp/ودل'},},
}}
local TextHelp = [[*- خير الكلام ماقل و........ ؟ *]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)MT3') then
local UserId = Text:match('(%d+)MT3')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = 'السؤال التالي ', data = IdUser..'S3'},},}}
local TextHelp = [[*↯︙  احسنت يا صديقي إجابتك صحيحة  *]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)S3') then
...
elseif Text and Text:match('(%d+)MT4') then
local UserId = Text:match('(%d+)MT4')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = 'السؤال التالي ', data = IdUser..'R9'},},}}
local TextHelp = [[*↯︙  احسنت يا صديقي إجابتك صحيحة  *]]
