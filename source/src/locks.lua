...
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل الرابط *").unLock,"md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Fast.."Status:Welcome"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل الترحيب *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"*↯︙ تم تعطيل الايدي *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل الايدي بالصوره *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل الردود *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل الردود العامه *").unLock,"md",true)
end
if TextMsg == 'صلاحيه حظر' or TextMsg == 'سحب صلاحيه حظر' or TextMsg == 'صلاحيات طرد' then
...
return send(msg_chat_id,msg_id,"*↯︙تم سحب صلاحيه الحظر من كل رتب ،*").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل الرفع *").unLock,"md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Fast.."Status:Games"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل الالعاب *").unLock,"md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Fast.."Status:KickMe"..msg_chat_id) 
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل اطردني *").unLock,"md",true)
end
if TextMsg == '⦗تعطيل البوت الخدمي⦘' then
...
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل البوت الخدمي *").unLock,"md",true)
end
if TextMsg == '⦗تعطيل التواصل⦘' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
return send(msg_chat_id,msg_id,"*↯︙ تم تعطيل التواصل داخل البوت *").unLock,"md",true)
end
...
if not msg.Ownerss and not Redis:get(Fast.."Status:BanId"..msg_chat_id) then
return send(msg_chat_id,msg_id,"↯︙تم سحب صلاحيه الحظر من رتبتك ، ","md",true)
end 
local UserId_Info = bot.searchPublicChat(UserName)
if not UserId_Info.id then
return send(msg_chat_id,msg_id,"\n↯︙ عذرآ لا يوجد حساب بهذا المعرف ","md",true)  
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم حظره من الكروب ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم كتمه في الكروب  ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تقييده في الكروب \n↯︙ لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم حظره من الكروب ").Reply,"md",false, false, false, false, reply_markup)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم الغاء حظره من الكروب  ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم كتمه في الكروب  ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تقييده في الكروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم الغاء تقييده من الكروب").Reply,"md",true)  
end
...
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم طرده من الكروب ").Reply,"md",true)  
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId) 
bot.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم حظره من الكروب ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم كتمه في الكروب  ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
if text == "⦗تعطيل وضع اشتراك لاعضاء⦘" then
if not msg.Asasy then  
return send(msg_chat_id,msg_id,'\n*❍ هذا الامر يخص  '..Controller_Num(1)..' * ',"md",true)  
end
...
if text == 'جلب المطورين ↯︙' or text == '⦗جلب ملف المطورين⦘' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == '⦗تعطيل جلب النسخه التلقائه⦘' then   
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
...
File:write(jsonn)
File:close()
bot.sendDocument(Sudo_Id,0,'./devs.json', '↯︙ تم جلب نسخه المطورين\n↯︙ تحتوي على '..#devs..' مطور و '..#devss..' مطور ثانوي\n', 'md')
local Get_Json = '{"BotId": '..Fast..','  
Get_Json = Get_Json..'"GroupsBotreply":{'
local Groups = Redis:smembers(Fast..'ChekBotAdd')  
