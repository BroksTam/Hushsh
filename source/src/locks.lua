...
if text == 'المضاد' or text =='اعدادات المضاد' then
local t = '*- اهلا بك عزيزي في قائمه المضاد .*'
local photo = bot.getUserProfilePhotos(Fast)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⦗ الصور ⦘', callback_data=senderr..'/Busi'},{text = '⦗ الهمسات ⦘', callback_data=senderr..'/Footba'},
},
{
{text = '⦗ الاباحي ⦘', callback_data=senderr..'/Busi'},{text = '⦗ التفليش ⦘', callback_data=senderr..'/Footba'},
},
{
{text = '⦗ الروابط ⦘', callback_data=senderr..'/lock_link'},{text = '⦗ التوجيه ⦘', callback_data=senderr..'/fwd'},
},
{
{text = '⦗ متحركه ⦘', callback_data=senderr..'/amu'},{text = '⦗ ملفات ⦘', callback_data=senderr..'/Sger'},
},
{
...
return send(msg_chat_id,msg_id,"↯︙تم سحب صلاحيه الحظر من كل رتب ، ","md",true)
end
