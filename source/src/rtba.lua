...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مالك ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
end
if UserName[1] == "منشئ اساسي" then
...
return send(msg_chat_id,msg_id,"↯︙ تم تفعيل امر منع التصفيه").unLock, 'md', true, false, reply_markup)
end
