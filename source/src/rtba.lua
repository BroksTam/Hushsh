function setrtb(msg)
function namesend(id)
local UserInfo = bot.getUser(id)
local urlid
local nameid
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
urlid = "t.me/"..UserInfo.username
else
urlid = "tg://user?id="..id
end
nameid = (UserInfo.first_name or "name" )
return bot.replyMarkup{type='inline',data={{{text = nameid, url = urlid}}}}
end
text = nil
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"↯︙ تم ترقيته مطور مساعد مسبقا ").Reply,"md",true, false, false, false, namesend(Message_Reply.sender_id.user_id))
else
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"↯︙ تم ترقيته  مطور مساعد").Reply,"md",true, false, false, false, namesend(Message_Reply.sender_id.user_id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"↯︙ تم تنزيله مطور مساعد مسبقا ").Reply,"md",true, false, false, false, namesend(Message_Reply.sender_id.user_id))
else
Redis:del(Fast.."Specialall:Group")
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"↯︙ تم تنزيله مطور مساعد").Reply,"md",true, false, false, false, namesend(Message_Reply.sender_id.user_id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ↯︙تم رفعه مطور اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."ControlAll:Groups",UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ↯︙تم رفعه مطور اساسي ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ↯︙تم تنزيله من المطورين الاساسيين مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."ControlAll:Groups",UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ↯︙تم تنزيله من المطوريين الاساسسين").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ↯︙تم رفعه مطور اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."ControlAll:Groups",rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ↯︙تم رفعه مطور اساسي ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ↯︙تم تنزيله من المطورين الاساسسين مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."ControlAll:Groups",rep_idd)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd," ↯︙تم تنزيله من المطوريين الاساسسين").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId," ↯︙تم رفعه مطور اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId))
else
Redis:sadd(Fast.."ControlAll:Groups",UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId," ↯︙تم رفعه مطور اساسي ").Reply,"md",true, false, false, false, namesend(UserId))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId," ↯︙تم تنزيله من المطوريين الاساسسين مسبقا").Reply,"md",true, false, false, false, namesend(UserId))
else
Redis:srem(Fast.."ControlAll:Groups",UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId," ↯︙تم تنزيله من المطوريين الاساسسين").Reply,"md",true, false, false, false, namesend(UserId))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه مدير عام ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم رفعه مدير عام ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end 
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله مدير عام ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مدير عام ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end 
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."Devss:Groups",UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور ثانوي").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."Dev:Groups",UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."Ownerss:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مالك ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."SuperCreator:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله منشئ اساسي ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."Creator:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المنشئين ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."Manger:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المدراء ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."Admin:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من الادمنيه ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:srem(Fast.."Special:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المميزبن ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."Devss:Groups",rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله مطور ثانوي").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."Dev:Groups",rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله مطور ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."Ownerss:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله مالك ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."SuperCreator:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله منشئ اساسي ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."Creator:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من المنشئين ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."Manger:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من المدراء ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."Admin:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من الادمنيه ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."Special:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من المميزبن ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مرتي" then
if not Redis:sismember(Fast.."kholat:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله   من قائمه زوجاتي سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."kholat:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه زوجاتي  ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "طلي" then
if not Redis:sismember(Fast.."wtka:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الطليان سابقا  ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."wtka:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الطليان الضاهر بطل يمعي ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "لوكي" then
if not Redis:sismember(Fast.."twhd:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه اللوكين سابقا  ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."twhd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه اللوكين الضاهر تعالج وبطل يتلوك ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "عسل" then
if not Redis:sismember(Fast.."twhd:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه العسل سابقا  ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."twhd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه العسل الضاهر طلع خرا ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "كيك" then
if not Redis:sismember(Fast.."klb:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الكيك سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."klb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الكيك يمكن طلع زربه ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مازوخي" then
if not Redis:sismember(Fast.."mar:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه المازوخيه سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."mar:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه المازوخيه يمكن تعالج ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "غبي" then
if not Redis:sismember(Fast.."smb:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الاغبياء سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."smb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الاغبياء يمكن صار ذكي ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "زاحف" then
if not Redis:sismember(Fast.."2rd:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الزواحف سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."2rd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الزواحف الظاهر بطل لطلطه ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "جلب" then
if not Redis:sismember(Fast.."3ra:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الحلاب سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."3ra:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه الجلاب يمكن بطل ينبح").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مطي" then
if not Redis:sismember(Fast.."8by:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه المطايه سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:srem(Fast.."8by:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم تنزيله من قائمه المطايه ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."Devss:Groups",UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مطور ثانوي").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."Dev:Groups",UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مطور ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."Ownerss:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مالك ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."SuperCreator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله منشئ اساسي ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."Creator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المنشئين ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."Manger:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المدراء ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."Admin:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من الادمنيه ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:srem(Fast.."Special:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المميزين ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."Devss:Groups",UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور ثانوي").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
if UserName[1] == "مطور" then
if not msg.Devss then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."Dev:Groups",UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
if UserName[1] == "مالك" then
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.Fastbots
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."Ownerss:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مالك ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
if UserName[1] == "منشئ اساسي" then
if not msg.Ownerss then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."SuperCreator:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ اساسي ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
if UserName[1] == "منشئ" then
if not msg.SuperCreator then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."Creator:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ  ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
if UserName[1] == "مدير" then
if not msg.Creator then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."Manger:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مدير  ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
if UserName[1] == "ادمن" then
if Redis:sismember(Fast.."Specialall:Group",senderr) then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."Admin:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته ادمن  ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
if UserName[1] == "مميز" then
if not msg.Admin then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
else
Redis:sadd(Fast.."Special:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مميز  ").Reply,"md",true, false, false, false, namesend(UserId_Info.id))
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."Devss:Groups",rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مطور ثانوي").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == 'مطور' then
if not msg.Devss then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مطور مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."Dev:Groups",rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مطور ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مالك" then
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.Fastbots
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."Ownerss:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مالك ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "منشئ اساسي" then
if not msg.Ownerss then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."SuperCreator:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته منشئ اساسي ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "منشئ" then
if not msg.SuperCreator then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."Creator:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته منشئ  ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مدير" then
if not msg.Creator then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."Manger:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مدير  ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "ادمن" then
if Redis:sismember(Fast.."Specialall:Group",senderr) then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."Admin:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته ادمن  ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مميز" then
if not msg.Admin then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."Special:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم ترقيته مميز  ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مرتي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه  بقائمه زوجاتك سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."kholat:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه    بقائمه زوجاتك الضاهر مرتب امورك").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "طلي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه الطليان سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."wtka:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه الطليان ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "لوكي" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Fast.."twhd:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه العسل سابقا  ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."twhd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه       بقائمه العسل وف شكد حات لعد").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "كيك" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه الـكيك سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."klb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه     بقائمه الـكيك وف كيك المجموعه  ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مازوخي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه المازوخيه سابقا  ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."mar:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه      بقائمه المازوخيه الله يطيح حظك حبي").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "غبي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه الاغبياء سابقا  ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."smb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه         بقائمه الاغبياء شوكت تصير ادمي وذكي ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "زاحف" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه الزواحيف سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."2rd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه      بقائمه الزواحيف ليا ملطلط ").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "جلب" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه الجلاب سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."3ra:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه      بقائمه الجلاب يلا انبح حبي").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
if TextMsg == "مطي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه بقائمه المطايه سابقا ").Reply,"md",true, false, false, false, namesend(rep_idd))
else
Redis:sadd(Fast.."8by:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"↯︙ تم رفعه  بقائمه المطايه يلا حبي نطو عربانه وخلي يشتغل").Reply,"md",true, false, false, false, namesend(rep_idd))
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."Devss:Groups",UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مطور ثانوي").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
if UserId[1] == 'مطور' then
if not msg.Devss then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مطور مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."Dev:Groups",UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مطور ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
if UserId[1] == "مالك" then
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.Fastbots
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."Ownerss:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مالك ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
if UserId[1] == "منشئ اساسي" then
if not msg.Ownerss then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."SuperCreator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ اساسي ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
if UserId[1] == "منشئ" then
if not msg.SuperCreator then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."Creator:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ  ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
if UserId[1] == "مدير" then
if not msg.Creator then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."Manger:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مدير  ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
if UserId[1] == "ادمن" then
if Redis:sismember(Fast.."Specialall:Group",senderr) then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."Admin:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته ادمن  ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
if UserId[1] == "مميز" then
if not msg.Admin then
...
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true, false, false, false, namesend(UserId[2]))
else
Redis:sadd(Fast.."Special:Group"..msg_chat_id,UserId[2]) 
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مميز  ").Reply,"md",true, false, false, false, namesend(UserId[2]))
end
end
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الرابط *").unLock,"md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Fast.."Status:Welcome"..msg_chat_id,true) 
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الترحيب *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"*↯︙ تم تفعيل الايدي *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الايدي بالصوره *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الردود *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الردود العامه *").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الحظر , الطرد , التقييد*").unLock,"md",true)
end
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الرفع *").unLock,"md",true)
end
if TextMsg == 'الالعاب' then
Redis:set(Fast.."Status:Games"..msg_chat_id,true) 
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل الالعاب *").unLock,"md",true)
end
if TextMsg == 'اطردني' then
Redis:set(Fast.."Status:KickMe"..msg_chat_id,true) 
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل اطردني *").unLock,"md",true)
end
if TextMsg == '⦗تفعيل البوت الخدمي⦘' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص ⦗  '..Controller_Num(1)..'  ⦘* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل البوت الخدمي *").unLock,"md",true)
end
if TextMsg == '⦗تفعيل التواصل⦘' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص ⦗  '..Controller_Num(1)..'  ⦘* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
return send(msg_chat_id,msg_id,"*↯︙ تم تفعيل التواصل داخل البوت *").unLock,"md",true)
end
